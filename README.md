...
два клиента - одного камера обслуживает, а другой клиент натыкается на ошибку.
Если при улучшенной схеме произойдёт такое, то все клиенты будут бесконечно
видеть черный экран до полной перезагрузки сервера. Поэтому внедрение такой 
